...
class Net:
    ...
    def __init__(self, hp: HyperParams, is_training=True):
        ...
        with tf.variable_scope('question_generator'):
            ...
            #     num_units=hp.Data.c3d_feature_num,
            #     memory=vq_qg,
            # )
            # seq2seq.AttentionWrapper(
            #     cell=rnn_cell,
            #     attention_mechanism=attention_mechanism,
            #     attention_layer_size=hp.Data.c3d_feature_num,
            #     name='attention_mechanism'
            # )
            # rnn_cell.zero_state(batch_size, dtype=tf.float32).clone(vq_qg)
            ...
            if is_training:
                ...
                # print('output:', self.rnn_output.shape)
